...
namespace winrt::VChat_WinUI3::implementation
{
    ...
    struct ServerManagerT : public ::winrt::VChat_WinUI3::implementation::ServerManager_base<D,
        ::winrt::Microsoft::UI::Xaml::Markup::IComponentConnector,
        I...>
    {
        using base_type = typename ServerManagerT::base_type;
        using base_type::base_type;
        using class_type = typename ServerManagerT::class_type;
    ...
    private:
        struct ServerManager_obj1_Bindings;
