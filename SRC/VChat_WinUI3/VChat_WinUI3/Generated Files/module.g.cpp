...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"VChat_WinUI3.MainWindow"))
    {
        return winrt_make_VChat_WinUI3_MainWindow();
    }

    if (requal(name, L"VChat_WinUI3.XamlMetaDataProvider"))
    {
        return winrt_make_VChat_WinUI3_XamlMetaDataProvider();
    }
