...
namespace winrt::VChat_WinUI3::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES XamlMetaDataProvider_base : implements<D, VChat_WinUI3::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = VChat_WinUI3::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"VChat_WinUI3.XamlMetaDataProvider";
        }
    };
}
namespace winrt::VChat_WinUI3::factory_implementation
{
    ...
    {
        using instance_type = VChat_WinUI3::XamlMetaDataProvider;
