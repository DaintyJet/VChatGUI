...
namespace winrt::VChat_WinUI3::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MainWindow_base : implements<D, VChat_WinUI3::MainWindow, composing, I...>,
        ...
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        ...
        using class_type = VChat_WinUI3::MainWindow;
        ...
        {
            return L"VChat_WinUI3.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::VChat_WinUI3::factory_implementation
{
    ...
    {
        using instance_type = VChat_WinUI3::MainWindow;
