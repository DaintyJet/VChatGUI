...
#pragma once
#ifndef WINRT_VChat_WinUI3_2_H
#define WINRT_VChat_WinUI3_2_H
#include "winrt/impl/Microsoft.UI.Xaml.1.h"
#include "winrt/impl/Microsoft.UI.Xaml.Markup.1.h"
#include "winrt/impl/VChat_WinUI3.1.h"
WINRT_EXPORT namespace winrt::VChat_WinUI3
{
    struct WINRT_IMPL_EMPTY_BASES MainWindow : winrt::VChat_WinUI3::IMainWindow,
        ...
        impl::require<MainWindow, winrt::Microsoft::UI::Xaml::IWindow, winrt::Microsoft::UI::Xaml::IWindow2>
    {
        ...
        MainWindow(void* ptr, take_ownership_from_abi_t) noexcept : winrt::VChat_WinUI3::IMainWindow(ptr, take_ownership_from_abi) {}
        MainWindow();
    };
